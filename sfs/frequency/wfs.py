...
def line_2d(omega, x0, n0, xs, c=None):
    ...
    .. plot::
        ...
        d, selection, secondary_source = sfs.frequency.wfs.line_2d(
...
def _point(omega, x0, n0, xs, c=None):
    ...
    .. plot::
        ...
        d, selection, secondary_source = sfs.frequency.wfs.point_3d(
            omega, array.x, array.n, xs)
        plot(d, selection, secondary_source)
...
def point_25d(omega, x0, n0, xs, xref=[0, 0, 0], c=None, omalias=None):
    ...
    .. plot::
        ...
        d, selection, secondary_source = sfs.frequency.wfs.point_25d(
            omega, array.x, array.n, xs)
        plot(d, selection, secondary_source)
...
def _plane(omega, x0, n0, n=[0, 1, 0], c=None):
    ...
    .. plot::
        ...
        d, selection, secondary_source = sfs.frequency.wfs.plane_3d(
...
def plane_25d(omega, x0, n0, n=[0, 1, 0], xref=[0, 0, 0], c=None,
    ...
    .. plot::
        ...
        d, selection, secondary_source = sfs.frequency.wfs.plane_25d(
            omega, array.x, array.n, npw)
        plot(d, selection, secondary_source)
...
def _focused(omega, x0, n0, xs, ns, c=None):
    ...
    .. plot::
        ...
        d, selection, secondary_source = sfs.frequency.wfs.focused_3d(
...
def focused_25d(omega, x0, n0, xs, ns, xref=[0, 0, 0], c=None,
    ...
    .. plot::
        ...
        d, selection, secondary_source = sfs.frequency.wfs.focused_25d(
            omega, array.x, array.n, xs_focused, ns_focused)
        plot(d, selection, secondary_source)
...
def plane_3d_delay(omega, x0, n0, n=[0, 1, 0], c=None):
    ...
    .. plot::
        ...
        d, selection, secondary_source = sfs.frequency.wfs.plane_3d_delay(
            omega, array.x, array.n, npw)
        plot(d, selection, secondary_source)
