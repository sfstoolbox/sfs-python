...
def point(omega, x0, grid, c=None):
    ...
    .. plot::
        ...
        p = sfs.monochromatic.source.point(omega, x0, grid)
...
def point_velocity(omega, x0, grid, c=None, rho0=None):
    ...
    .. plot::
        ...
        v = sfs.monochromatic.source.point_velocity(omega, x0, vgrid)
        sfs.plot.soundfield(p * normalization_point, grid)
...
def point_dipole(omega, x0, n0, grid, c=None):
    ...
    .. plot::
        ...
        n0 = 0, 1, 0
        p = sfs.monochromatic.source.point_dipole(omega, x0, n0, grid)
        sfs.plot.soundfield(p, grid)
...
def line(omega, x0, grid, c=None):
    ...
    .. plot::
        ...
        p = sfs.monochromatic.source.line(omega, x0, grid)
        sfs.plot.soundfield(p, grid)
...
def line_velocity(omega, x0, grid, c=None, rho0=None):
    ...
    .. plot::
        ...
        v = sfs.monochromatic.source.line_velocity(omega, x0, vgrid)
        sfs.plot.soundfield(p * normalization_line, grid)
...
def plane(omega, x0, n0, grid, c=None):
    ...
    .. plot::
        ...
        p = sfs.monochromatic.source.plane(omega, x0, n0, grid)
...
def plane_velocity(omega, x0, n0, grid, c=None, rho0=None):
    ...
    .. plot::
        ...
        v = sfs.monochromatic.source.plane_velocity(omega, x0, n0, vgrid)
        sfs.plot.soundfield(p, grid)
...
def pulsating_sphere(omega, center, radius, amplitude, grid, inside=False,
    ...
    .. plot::
        ...
        p = sfs.monochromatic.source.pulsating_sphere(omega, x0, radius, amplitude, grid)
        sfs.plot.soundfield(p, grid)
...
def pulsating_sphere_velocity(omega, center, radius, amplitude, grid, c=None):
    ...
    .. plot::
        ...
        v = sfs.monochromatic.source.pulsating_sphere_velocity(
            omega, x0, radius, amplitude, vgrid)
        sfs.plot.soundfield(p, grid)
        sfs.plot.vectors(v, vgrid)
