...
def line_2d(omega, x0, n0, xs, c=None):
    ...
    .. plot::
        ...
        d, selection, secondary_source = sfs.monochromatic.sdm.line_2d(
...
def plane_2d(omega, x0, n0, n=[0, 1, 0], c=None):
    ...
    .. plot::
        ...
        d, selection, secondary_source = sfs.monochromatic.sdm.plane_2d(
...
def plane_25d(omega, x0, n0, n=[0, 1, 0], xref=[0, 0, 0], c=None):
    ...
    .. plot::
        ...
        d, selection, secondary_source = sfs.monochromatic.sdm.plane_25d(
...
def point_25d(omega, x0, n0, xs, xref=[0, 0, 0], c=None):
    ...
    .. plot::
        ...
        d, selection, secondary_source = sfs.monochromatic.sdm.point_25d(
