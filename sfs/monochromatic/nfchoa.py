...
def plane_2d(omega, x0, r0, n=[0, 1, 0], max_order=None, c=None):
    ...
    .. plot::
        ...
        d, selection, secondary_source = sfs.monochromatic.nfchoa.plane_2d(
            omega, array.x, R, npw)
...
def point_25d(omega, x0, r0, xs, max_order=None, c=None):
    ...
    .. plot::
        ...
        d, selection, secondary_source = sfs.monochromatic.nfchoa.point_25d(
            omega, array.x, R, xs)
        plot(d, selection, secondary_source)
...
def plane_25d(omega, x0, r0, n=[0, 1, 0], max_order=None, c=None):
    ...
    .. plot::
        ...
        d, selection, secondary_source = sfs.monochromatic.nfchoa.plane_25d(
            omega, array.x, R, npw)
        plot(d, selection, secondary_source)
